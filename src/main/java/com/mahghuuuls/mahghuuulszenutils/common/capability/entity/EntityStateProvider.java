...
public class EntityStateProvider implements ICapabilitySerializable<NBTTagCompound> {

    public static final ResourceLocation NAME =
            new ResourceLocation(MahZenUtils.MOD_ID, "entity_state");

    @CapabilityInject(IEntityState.class)
    public static final Capability<IEntityState> CAPABILITY = null;

    private final IEntityState instance = new EntityState();
